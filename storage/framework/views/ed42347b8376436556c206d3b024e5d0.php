        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-form">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="form">Form Elements</a></li>
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form action="<?php echo e($display->pid); ?>" method="POST" enctype="multipart/form-data" class="forms-sample">
                      <?php echo csrf_field(); ?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group col-xs-12">
                          <input type="text" class="form-control file-upload-info" disabled="" placeholder="Upload Book Pdf" value="<?php echo e($display->file); ?>">
...
</html><?php /**PATH D:\laravel files\ecom\resources\views/admin/pages/forms/bookpdf-details.blade.php ENDPATH**/ ?>