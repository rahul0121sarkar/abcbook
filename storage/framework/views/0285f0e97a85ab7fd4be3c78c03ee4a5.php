                  ...
                  <div class="card-body">
                    ...
                    <form action="insert" method="POST" enctype="multipart/form-data" class="forms-sample">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="subject" id="Description" placeholder="Enter The subject">
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" name="message" id="exampleTextarea1" rows="4" placeholder="Enter your message"></textarea>
                      </div>
...
</html><?php /**PATH D:\ecom\resources\views/admin/pages/tables/contact-edit.blade.php ENDPATH**/ ?>